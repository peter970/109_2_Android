...
public class CalculatorTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void zero_negetive() {
        mCalculator.pow(0d, -1d);
    }

    @Test(expected = IllegalArgumentException.class)
    public void zero_anynegetive() {
        mCalculator.pow(0d, -2d);
    }
}